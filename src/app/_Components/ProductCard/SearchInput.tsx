  ...
  return (
    <form onSubmit={handleSubmit} className="mb-6 flex justify-center">
      <input
        ...
        className="w-full max-w-md px-4 py-2 border rounded-full shadow-sm focus:outline-none focus:ring-2 focus:ring-pink-400 bg-white dark:bg-gray-800 text-black dark:text-white border-gray-300 dark:border-gray-700"
      />
      <button
        type="submit"
